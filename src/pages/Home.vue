        ...
        <div class="newsletter">
          ...
          <div class="form">
            <div class="input-group">
              <input type="email" class="form-control" placeholder="Adicionar seu e-mail" aria-label="Adicionar seu e-mail" aria-describedby="button-addon2">
        ...
        <div class="footer-bottom">
          ...
          <router-link to="/mapa" class="button-primary-link">
            <div class="logo-button">
              <img src="@/assets/images/logo-urbverde-white.svg" width="39px" height="40px"  alt="Logo da UrbVerde" />
          ...
          <div class="links body-small-medium">
            ...
            <a href="https://urbverde-educa.tawk.help/" target="_blank" rel="noopener noreferrer">
              UrbVerde Educa
            </a>
            <a href="https://urbverde-educa.tawk.help/" target="_blank" rel="noopener noreferrer">
              Contatos
          ...
          <div class="midias">
            <a href="http://wa.me/5511916709802" target="_blank" rel="noopener noreferrer">
              <img src="@/assets/images/homepage/media-links/media-link-01.svg" alt="WhatsApp Link">
            </a>
            <a href="mailto:comunica.urbverde@usp.br" target="_blank" rel="noopener noreferrer">
              <img src="@/assets/images/homepage/media-links/media-link-02.svg" alt="E-mail Link">
            </a>
            <a href="https://instagram.com/urb.verde" target="_blank" rel="noopener noreferrer">
              <img src="@/assets/images/homepage/media-links/media-link-03.svg" alt="Instagram Link">
            </a>
            <a href="https://www.linkedin.com/company/urbverde/" target="_blank" rel="noopener noreferrer">
              <img src="@/assets/images/homepage/media-links/media-link-04.svg" alt="LinkedIn Link">
            </a>
            <a href="https://www.youtube.com/@urb_verde" target="_blank" rel="noopener noreferrer">
              <img src="@/assets/images/homepage/media-links/media-link-05.svg" alt="Youtube Link">
            </a>
          </div>
...
export default {
  ...
  .footer .footer-bottom .logo-button{
    display: flex;
    align-items: center;
    gap: 12px;
    color: map-get($gray, white);
  ...
  .footer .footer-bottom .midias{
    display: flex;
    align-items: center;
    gap: 8px;
  }

  .footer .footer-bottom .midias img{
    width: 36px;
    height: 36px;
  }
